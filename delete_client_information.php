...
<body>
        ...
        <div class="app-main">
            ...
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            ...
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_client_info($client_id);
                            }
                        }
                            if(isset($msg))
                            {
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div>
                                    <h1 style="margin-left:280px;"> Show Client Information </h1>
                                </div>
                            </div>
  ...
  <?php while($element = mysqli_fetch_assoc($item)){ ?>
    <tr>
      ...
      <td><?php echo $element['agent_name']?></td>
      ...
      <td><?php echo $element['nid']?></td>
      <td><?php echo $element['dob']?></td>
      <td><?php echo $element['passport_number']?></td>
      <td><?php echo $element['passport_experied_date']?></td>
      <td><img src="storage/client_image/<?php echo $element['image']?>" height="50" width="50"></td>
      <td><a class="btn btn-danger" href="delete_client_information.php?data=delete&&client_id=<?php  echo $element ['id'];?>" role="button"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
