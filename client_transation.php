...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        ...
        <div class="app-main">
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div>
                                    <h1 style="margin-left:280px;"> Insert Client Transation </h1>
                                </div>
                            </div>
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->add_client_transation($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
        ...
        <div class="coloum justify-container" >
            ...
            <form action="client_transation.php" method="POST">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-inline"style="width:150px">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Number" style=" margin-left:5px" name="invoice">
                                </div> 
                            </div>
                        </div>
                <br>
