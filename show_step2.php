                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div>
                                    <h1 style="margin-left:280px;"> Show Client Document Step-2</h1>
                                </div>
                            </div>
                        ...
                        <thead>
                         ...
                         <?php while($element = mysqli_fetch_assoc($item)){ ?>
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="page_document_step-2.php?data=show&&doc_id=<?php  echo $element ['id'];?>" role="button">Show</a>
                               </td>
                            </tr>
                            <?php }?>
                         </tbody>
