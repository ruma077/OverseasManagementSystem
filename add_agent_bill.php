...
<body>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div>
                                    <h1 style="margin-left:280px;"> Show Agent Bill </h1>
                                </div>
                            </div>
  ...
  <?php while($element = mysqli_fetch_assoc($item)){ ?>
    <tr>
      ...
      <td><a class="btn btn-primary" href="agent_page_bill.php?data=delete&&agent_id=<?php  echo $element ['id'];?>" role="button">Show</a></td>
    </tr>
    <?php }?>
  </tbody>
</table>
