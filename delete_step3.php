                ...
                <div class="app-main__inner">
                    ...
                    <div>
                        ...
                        if(isset($_GET['data']))
                        {
                            ...
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_client_doc_step_3($client_id);
                            }
                        }
                            if(isset($msg))
                            {
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            $obj = new Show();
                            $item = $obj->show_client_doc_step3();
                        ?>
                <!-- Contant -->
              <div class="row">
                       ...
                       <thead>
                        ...
                        <?php while($element = mysqli_fetch_assoc($item)){ ?>
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-danger" href="delete_step3.php?data=delete&&client_id=<?php  echo $element ['id'];?>" role="button">Delete</i></a></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
